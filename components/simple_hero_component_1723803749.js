                ...
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div id="hero-form-container" class="mt-8">
                        <form class="space-y-4">
                            ...
                            <div>
                            <div>
                                <label for="narraow" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Narraow</label>
                                <input type="text" id="narraow" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
                            <div>
                                <label for="nioa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nioa</label>
                                <input type="text" id="nioa" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
                            <div>
                                <label for="yue" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Yue</label>
                                <input type="text" id="yue" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
                            </div>
                            <div>
                                <label for="triwa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Triwa</label>
                                <input type="text" id="triwa" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
                            <div>
                                <label for="nhiq" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nhiq</label>
                                <input type="text" id="nhiq" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
                            <div>
                            <div>
                            <div>
